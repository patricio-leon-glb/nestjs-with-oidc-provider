      ...
      clients: [
        {
          ...
          client_secret:
            'TUPFhzlvWuNlQ38fUMzg4lYPRXA2DCnxE6TwnvHUq637i5kqktwINHPIHi7vT2Ds',
          redirect_uris: [
            'http://localhost:3000/v1/callback',
            'http://localhost:3000/v1/client/callback',
          ],
        },
      ],
      cookies: {
        keys: ['unho7237o8lcsd)l8e', 'llsal126d4'],
      },
      jwks: {
        keys: [
          {
